...
function requestTooFast(startedAt: number): boolean {
...
export async function POST(request: Request) {
  ...
  // Quietly accept obvious bot submissions without storing personal data.
  if (submission.website || requestTooFast(submission.startedAt)) {
