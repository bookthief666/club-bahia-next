    ...
    <OverlayFrame title="Close Reservations overlay" onClose={onClose}>
      <div className="mx-auto flex min-h-full max-w-4xl flex-col justify-center">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          <a href="/reservations" className="rounded-full border border-amber-100/25 px-6 py-3 text-center text-sm uppercase tracking-[0.18em] text-amber-100 transition hover:border-red-300/60 hover:text-white focus:outline-none focus:ring-2 focus:ring-red-500 sm:tracking-[0.22em]">Start Reservation</a>
