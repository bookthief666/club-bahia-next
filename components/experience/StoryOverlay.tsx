    ...
    <OverlayFrame title="Close Our Story overlay" onClose={onClose}>
      <div className="grid min-h-full items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          ...
          <h2 className="font-serif text-[clamp(4rem,15vw,10rem)] leading-[0.78] tracking-[-0.08em]">{experienceCopy.story.heading}</h2>
        ...
        <div className="rounded-[2rem] border border-red-500/25 bg-red-950/10 p-6 text-center shadow-[0_0_60px_rgba(225,18,27,0.16)]">
          <BahiaOrnament />
          <p className="mt-8 text-xs uppercase tracking-[0.28em] text-amber-100/60">Future asset slot: Club Bahia exterior illustration</p>
        </div>
      </div>
    </OverlayFrame>
  );
