...
export function SiteHeader() {
  return (
    <header className="fixed inset-x-0 top-0 z-40 border-b border-sunsetGold/15 bg-bahiaBlack/58 shadow-[0_10px_40px_rgba(0,0,0,.26)] backdrop-blur-xl">
      <nav aria-label="Main navigation" className="mx-auto flex h-12 max-w-6xl items-center justify-between px-4 sm:h-16 sm:px-6 lg:px-8">
        ...
        <a href="#reservations" className="rounded-full border border-sunsetGold/50 bg-warmIvory/5 px-3.5 py-1.5 text-xs font-black uppercase tracking-[0.16em] text-warmIvory shadow-[inset_0_1px_0_rgba(255,255,255,.08)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-amberGlow md:hidden">Reserve</a>
      </nav>
    </header>
  );
}
